      ...
      <div className="px-4">
        ...
        <div className="mt-10 flex justify-around">
          <Link href="/profile/sold" className="flex flex-col items-center">
            <div
              className="w-14 h-14 text-white bg-orange-400 rounded-full
          flex items-center justify-center hover:bg-orange-300 transition"
            >
              <svg
                className="w-6 h-6"
                fill="none"
            ...
            <span className="text-sm font-medium text-g-700 mt-2">판매내역</span>
          </Link>
          ...
          flex items-center justify-center hover:bg-orange-300 transition"
            ...
            <span className="text-sm font-medium text-g-700 mt-2">구매내역</span>
          </Link>
